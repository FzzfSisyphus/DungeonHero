...
- ​	01/07 write epic and user stories for user interfaces

- ​	04/07 write seven user stories for usaged of entities    

- ​	05/07 write two user stories for collecing sword and getting to the exit

   Franky:

   write user stories for player and item.

### Week-06
​	Changyong:

- ​    09/07 add issues for label - "collect epic" at git lab board

- ​    10/07 add issues for label - "UI" and role/goal/benefit marks at git lab board

- ​    11/07 complete adding all SP and priority tags for all user stories
  ​            create basic_movement branch and implement functionality of walls blocking player
- ​    12/07 discuss with team member about domain model design and modify UML diagram by adding classes and associations
  ​            create strategy pattern for blockbehavior and push to basic_movement

Franky: 

​	some basic issues/board on gitlab board.

### Week-07
​	Changyong:
- 13/07 add simple classes and modify WallBlockBehavior 
- 14/07 add update function in player, dungeon and enemy class and add funtionality of player picking up sword
- 16/07 use item interface to implement picking up sword and add junit test structure
- 17/07 add test for DoorBlockBehavior, Wallblockbehavior, player opening door and collecting treasures.
- 18/07 add test for testing pushing a boulder, add functionality of pushing a boulder and add exit test
- 19/07 fix functionality of pushing a boulder, add enemy test and fix changes for Exit
- 20/07 add simpleSwordTest and fix switchfloor
-       create UML and design pattern file with teammate
...
- Potion and Portal
- Switch Floor  
- Switch floor test , enemy test, potion test
